...
// see https://github.com/timschreiner/genny
...
func generateSpecific(filename string, in io.ReadSeeker, typeSet map[string]string) ([]byte, error) {
	...
	names := make(map[string]namedType)
	...
	for scanner.Scan() {
		...
		for t, specificType := range typeSet {
			...
			specificType = nt.specificType
			specificName := nt.specificName
